...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <?php echo render_input('email','Email',$value,'email',array('autocomplete'=>'off','readonly'=>'readonly')); ?>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-12">
        ...
        <div class="input-group">
        <?php $value = (isset($member) ? $member['mail_signature'] : 'Sent from Plateform'); ?>
