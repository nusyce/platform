...
$(document).ready(function () {
  ...
  var kanban_board_data = [{
      ...
      item: [{
          ...
          attachment: 3,
          users: [
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-11.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-12.jpg"
          ]
        },
        {
          id: "12",
          ...
          border: "info",
          image: "<?= base_url()?>/assets/app/images/banner/banner-21.jpg",
          dueDate: "Feb 10"
        },
        {
          id: "13",
          ...
          attachment: 4,
          users: [
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-1.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-18.jpg"
          ]
        },
        {
          id: "14",
          ...
          attachment: 2,
          users: [
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-26.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-16.jpg"
          ]
        },
        {
          id: "15",
    ...
    },
    {
      ...
      item: [{
        ...
        },
        {
          ...
          comment: 8,
          users: [
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-24.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-14.jpg"
          ]
        },
        {
          id: "23",
    ...
    },
    {
      ...
      item: [{
          ...
          comment: 10,
          users: [
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-20.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-22.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-13.jpg"
          ]
        },
        {
          id: "32",
        ...
        },
        {
          ...
          users: [
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-1.jpg",
            "<?= base_url()?>/assets/app/images/portrait/small/avatar-s-2.jpg"
          ]
        }
      ]
    }
