...
<?php echo form_open_multipart(admin_url('task/task/' . $id), array('id' => 'task-form')); ?>
                  ...
                  <label for="task_is_billable"><?php /*echo _l('task_billable'); */ ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php echo render_select('task_for[]', $staff, array('admin_id', array('firstname', 'lastname')), get_menu_option('staff', _l(get_transl_field('tsl_tasks', 'mitarbeiter', 'Mitarbeiter'))), $selected, array('multiple' => true), array(), '', 'members', false); ?>
                            </div>
                            <div class="col-md-6">
                        ...
                        <?php echo render_input('name', 'Betreff', $value); ?>
                        <div style="display: none" class="task-hours hide<?php if (isset($task) && $task->rel_type == 'project' && total_rows(db_prefix() . 'projects', array('id' => $task->rel_id, 'billing_type' => 3)) == 0) {
                            echo ' hide';
                        } ?>">
                            <?php $value = (isset($task) ? $task->hourly_rate : 0); ?>
                            <?php echo render_input('hourly_rate', 'task_hourly_rate', $value); ?>
                        </div>
                        <div class="project-details hide" style="display:none;">
                            <div class="form-group">
                        ...
                        echo render_textarea('description', '', (isset($task) ? html_entity_decode($task->description) : ''), array('rows' => 6, 'placeholder' => _l('Beschreibung hinzufügen'))); ?>

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="priority"
                                           class="control-label"><?php echo _l('Priorität'); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="repeat_every"
                                           class="control-label"><?php echo _l('Alle X wiederholen'); ?></label>
                        ...
                        <div id="cycles_wrapper"
                            ...
                            <div class="form-group recurring-cycles">
                                <label for="cycles"><?php echo _l('Alle X wiederholen'); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-addon">
                                        <div class="">
                                            ...
                                            <label for="unlimited_cycles"><?php echo _l('Unendlich'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div  class="form-group checklist-templates-wrapper<?php if (count($checklistTemplates) == 0 || isset($task)) {
                            ...
                            <label for="checklist_items"><?php echo _l('Checklistenvorlagen einfügen'); ?></label>
