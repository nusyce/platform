    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_input('title', _l('utility_calendar_new_event_placeholder')); ?>
                        <?php echo render_textarea('description', _l('event_description'), '', array('rows' => 5)); ?>
                    </div>

                    <div class="col-md-6">
                        <?php echo render_select('user[]', $staffs, array('admin_id', array('firstname', 'lastname')), 'Mitabeiter', '', array('required' => true, 'multiple' => true)); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php echo render_datetime_input('start', _l('utility_calendar_new_event_start_date')); ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo render_datetime_input('end', _l('utility_calendar_new_event_end_date')); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php } ?>
                        <hr />
                        <p class="bold" style="margin: 0 0 10px;"><?php echo _l('event_color'); ?></p>
                        <?php
                        $event_colors = '';
