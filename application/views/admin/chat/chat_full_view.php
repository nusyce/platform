...
init_head();
?>
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/chat/css/chat_full_view.css">
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/chat/css/chat_styles.css">
<style>
	body {
...
<div class="app-content content">
    ...
    <div id="frame">
        ...
        <div id="sidepanel">
            <div id="profile">
                <div class="wrap">
					<?php echo user_profile_image($current_user->staffid, ['img img-responsive staff-profile-image-small pull-left']);?>
      ...
      <div class="dropdown">
      <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="display: none">
      ...
      <li class="i_groups"><a href="javascript:void(0)"><i class="fa fa-users" aria-hidden="true"></i></i>' . _l('chat_message_groups_text') . '</a></li>
            ...
            <div class="tab-content">
                <div id="staff" class="tab-pane fade in active">
                    <div id="contacts" style="overflow-y: scroll;height: 65vh;" class="contact-list">
        ...
        <div class="content">
          ...
          <img style="width: 40px" src="<?php echo module_dir_url('prchat', 'assets/chat_implements/userIsTyping.gif'); ?>"/>
        </span>
                <ul>
                </ul>
            </div>
            ...
            <!-- Groups -->
            <form  enctype="multipart/form-data" name="groupFileForm" id="groupFileForm" method="post"
            ...
            <form  method="post" enctype="multipart/form-data" name="groupMessagesForm" id="groupMessagesForm"
                  onsubmit="return false;">
...
<?php require('modules/prchat/assets/module_includes/mutual_and_helper_functions.php'); ?>
    ...
    <script>
        ...
        var presenceChannel = pusher.subscribe('presence-mychanel-'+"<?php echo get_user_company_id();?>");
